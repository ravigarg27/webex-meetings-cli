...
EXIT_CODE_MAP: dict[DomainCode, int] = {
    ...
    DomainCode.CAPABILITY_ERROR: 5,
    DomainCode.STATE_ERROR: 2,
    DomainCode.CONFLICT_ERROR: 8,
...
RETRYABLE_MAP: dict[DomainCode, bool] = {
    ...
    DomainCode.CAPABILITY_ERROR: False,
    DomainCode.STATE_ERROR: True,
    DomainCode.CONFLICT_ERROR: False,
